...
{
    External (_SB_.BSFQ, FieldUnitObj)
    External (_SB_.CFGD, IntObj)
    External (_SB_.HWPE, IntObj)
    External (_SB_.HWPV, IntObj)
    External (_SB_.IS00, FieldUnitObj)
    External (_SB_.MXP1, FieldUnitObj)
    External (_SB_.OSCP, IntObj)
    External (_SB_.P100, FieldUnitObj)
    External (_SB_.PR00, DeviceObj)
    External (_SB_.RPEF, FieldUnitObj)
